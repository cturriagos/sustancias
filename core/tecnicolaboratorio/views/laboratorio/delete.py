...
class LaboratorioDeleteView(LoginRequiredMixin, IsUserUCSCSF, ValidatePermissionRequiredMixin, UserNotifications,
                            DeleteView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['urls'] = [
            ...
            {"uridj": reverse_lazy('tl:eliminarlaboratorio', kwargs={'pk': self.object.id}), "uriname": "Eliminar"}
        ]
        return context
